export function Exercise2(){
    ...
    const Students = [
        { id: 1, name: "Hiếu", age: 20, grade: 10.0 },
        { id: 2, name: "Anh", age: 22, grade: 7.0 },
        { id: 3, name: "Đan", age: 21, grade: 9.0 },
        { id: 4, name: "Trịnh", age: 23, grade: 6.5 },
        { id: 5, name: "Trần", age: 20, grade: 8.0 },
        { id: 6, name: "Phương", age: 22, grade: 7.5 },
        { id: 7, name: "Tuấn", age: 21, grade: 9.5 },
    ...
    //Tính tổng trung bình grade của topStudents
    ...
    return (
        <div>
            ...
            <table border="1" cellPadding="5" >
                ...
                <tfoot>
                    <tr>
                        <td colSpan="3"><strong>Trung bình Grade</strong></td>
